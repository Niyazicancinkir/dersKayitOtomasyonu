...
{
    public partial class FiltrelenmisTranskriptcs : Form
    {
        public FiltrelenmisTranskriptcs()
        {
            InitializeComponent();
        }
        ...
        public string donemderscek2101 = "select * from DERS where donem='2021/1' and harf_notu !='' order by harf_notu";
        public string donemderscek2102 = "select * from DERS where donem='2021/2' and harf_notu !='' order by harf_notu";
        public string donemderscek2201 = "select * from DERS where donem='2022/1' and harf_notu !='' order by harf_notu";
        public string donemderscek2202 = "select * from DERS where donem='2022/2' and harf_notu !='' order by harf_notu";


        public string tablovericekGenel = "select * from DERS where harf_notu != ''  order by donem  ";
        private void button1_Click(object sender, EventArgs e)
        {
            this.Close();
        }

        private void FiltrelenmisTranskriptcs_Load(object sender, EventArgs e)
        {
